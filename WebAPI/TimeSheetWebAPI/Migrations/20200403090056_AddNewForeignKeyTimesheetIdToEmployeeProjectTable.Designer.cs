...
namespace TimeSheetWebAPI.Migrations
{
    ...
    [Migration("20200403090056_AddNewForeignKeyTimesheetIdToEmployeeProjectTable")]
    partial class AddNewForeignKeyTimesheetIdToEmployeeProjectTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TimeSheetWebAPI.Models.TimeSheet", b =>
                {
                    ...
                    b.Property<int>("DayFiveHours")
                        .HasColumnType("int");

                    b.Property<int>("DayFourHours")
                        .HasColumnType("int");

                    b.Property<int>("DayOneHours")
                        .HasColumnType("int");

                    b.Property<int>("DaySevenHours")
                        .HasColumnType("int");

                    b.Property<int>("DaySixHours")
                        .HasColumnType("int");

                    b.Property<int>("DayThreeHours")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TimeSheetWebAPI.Models.Employee", null)
                        .WithMany()
